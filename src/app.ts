  ...
  app.use(helmet({
    ...
    contentSecurityPolicy: {
      directives: {
        ...
        styleSrc: ["'self'", "'unsafe-inline'", "https://*.cashfree.com"],
        imgSrc: ["'self'", 'data:', 'res.cloudinary.com', "https://*.razorpay.com", "https://*.cashfree.com"],
        connectSrc: [
          "'self'",
          "https://*.razorpay.com",
          "wss://*.razorpay.com",
        ...
        frameSrc: ["'self'", "https://*.razorpay.com", "https://*.cashfree.com", "https://sandbox.cashfree.com", "https://api.cashfree.com"],
        formAction: ["'self'", "https://*.razorpay.com", "https://api.razorpay.com", "https://*.cashfree.com", "https://sandbox.cashfree.com", "https://api.cashfree.com"],
      },
    },
  }));
